  ...
  function formLogin() {
    return (
      <div>
        ...
        {notification && !user && (
          <div id="notificationRed">{message}</div>
        )}{" "}
        <br />
        <div>
          username
  ...
  function returnFormCreateBlog() {
    return (
      <CreateNewBlog
        ...
        setToggleCreateBlog={setToggleCreateBlog}
        updateAtualBlogs={updateAtualBlogs}
      />
    )
  }
  ...
  function blogsLogged() {
    ...
    return (
      <div>
        ...
        {notification && user && (
          <div id={red ? "notificationRed" : "notificationGreen"}>
            {message}
          </div>
        )}
        ...
        <p>
          {user.name} logged in{" "}
          <button id="buttonLogout" onClick={() => handleLogout()}>logout</button>
        </p>

        <button id="create-button"
          style={toggleCreateBlog ? { display: "none" } : { display: "block" }}
          onClick={() => setToggleCreateBlog(!toggleCreateBlog)}
        >
